        ...
        <div id="sidebar" class="sidebar fixed left-0 top-16 h-full shadow-lg z-40 flex flex-col transition-all duration-300 ease-in-out">
            ...
            <div class="overflow-y-auto flex-1">
                ...
                <div class="module-item">
                    ...
                    <div class="part-item">
                        <div class="part-header p-3 bg-gray-100 flex items-center justify-between" data-part-id="<?php echo $part['id']; ?>">
                            <h4 class="font-medium ml-2 text-gray-700 flex-1"><?php echo htmlspecialchars($part['title']); ?></h4>
                            <svg class="chevron w-5 h-5 text-gray-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php if ($selected_quiz_id): ?>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="quiz-container p-6 rounded-lg">
                    <h2 class="text-2xl font-bold mb-6 text-gray-800">Final Quiz: <?php echo $finalQuizTitle; ?></h2>
                    
                    <?php if ($quiz_completed && !$canRetakeFinalQuiz): ?>
                        <div class="text-center p-8 bg-green-50 rounded-lg">
                            ...
                            <?php else: ?>
                                <p class="text-orange-800 mb-6">Retakes are currently disabled for this quiz.</p>
                            <?php endif; ?>
                            <p class="text-green-800 mb-6">Thank you for completing this Module.</p>
                    ...
                    <?php else: ?>
                        <?php if ($quiz_completed && $canRetakeFinalQuiz): ?>
                            <div class="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-md">
                                <h3 class="font-semibold text-blue-900 mb-2">Retake Enabled</h3>
                                <p class="text-blue-800">Your previous score: <?php echo isset($quiz_score) ? $quiz_score : 0; ?>%. You can retake this quiz to improve your score.</p>
                            </div>
                        <?php endif; ?>
