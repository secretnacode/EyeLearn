    ...
    <div class="flex min-h-screen pt-16">
        ...
        <div class="p-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                    ...
                    <p class="text-gray-600 mb-4">Your personalized learning journey continues. Based on your eye tracking data, we've tailored your content to optimize your comprehension.</p>
                            ...
                            <!-- Combined layout for Module Performance + AI Feedback -->
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                                        ...
                                        <div class="bg-white p-6 rounded-lg shadow-md">
                                            <h2 class="text-xl font-semibold text-gray-800 mb-4">Module Performance Overview</h2>
                                            <div id="module-performance" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div class="bg-white p-6 rounded-lg shadow-md relative">
                                            <h2 class="text-xl font-semibold text-gray-800 mb-4">AI Mentor Feedback</h2>
                                            ...
                                            $result = $conn->query("
                                                SELECT qr.score, ar.ai_feedback, ar.created_at
                                                FROM quiz_results qr
                                                LEFT JOIN ai_recommendations ar ON qr.user_id = ar.user_id 
                                                    AND qr.module_id = ar.module_id
                                            ...
                                            if ($result && $result->num_rows > 0) {
                                                ...
                                                $latest_score = intval($data['score']);
                                                $latest_feedback = $data['ai_feedback'];
                                            }
                                            ?>
                                            ...
                                            <div id="ai-feedback-container" class="mt-4">
                                                <?php if ($latest_feedback): ?>
                                                    <div 
                                                        id="ai-feedback-card"
                                                        class="relative bg-gray-50 p-4 rounded-md border border-gray-200 cursor-pointer transition-all duration-500 ease-in-out overflow-hidden max-h-32 hover:shadow-md"
                                                    >
                                                        <p id="ai-feedback-text" class="text-gray-700 whitespace-pre-line text-sm leading-relaxed">
                                                            <?php echo nl2br(htmlspecialchars($latest_feedback)); ?>
                                                        </p>

                                                        <!-- Gradient fade + hint -->
                                                        <div id="ai-feedback-hint" class="absolute bottom-0 left-0 w-full text-center bg-gradient-to-t from-gray-50 to-transparent py-2 text-sm text-blue-600">
                                                ...
                                                <?php elseif ($latest_score !== null && $latest_score < 70): ?>
                                                    <div class="text-center text-gray-600">
                                                        <p class="mb-4">Your recent score was <strong><?php echo $latest_score; ?>%</strong> — let’s generate personalized study tips!</p>
                                                ...
                                                <?php elseif ($latest_score !== null && $latest_score >= 70): ?>
                                                    <div class="text-center text-green-700">
                                                        ...
                                                        <p>You scored <strong><?php echo $latest_score; ?>%</strong>. Keep up the great progress!</p>
                                    ...
                                    <!-- JS to handle AI Feedback generation (updated to use your original gemini_service.php) -->
                                        <script>
                                            ...
                                            btn.addEventListener('click', async () => {
                                                ...
                                                try {
                                                    ...
                                                    if (aiData.success && aiData.ai_feedback) {
                                                        container.innerHTML = `
                                                            <div class="max-h-64 overflow-y-auto bg-gray-50 p-4 rounded-md border border-gray-200">
                                        ...
                                        document.addEventListener('DOMContentLoaded', () => {
                                            ...
                                            let expanded = false;
                                            let collapsedHeight = 128; // Tailwind max-h-32
                                            let expandedHeight = null;

                                            const expandCard = () => {
                                                expanded = true;
                                                expandedHeight = text.scrollHeight + 40;
